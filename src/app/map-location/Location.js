...
const Location = () => {
  ...
  useEffect(() => {
    ...
    function renderCity(data) {
      ...
      districts.onchange = function () {
        ...
        if (this.value !== "") {
          const dataCity = result[0].Districts.filter(
            (n) => n.Id === this.value
          )[0].Wards;
  ...
  return (
    <div className="container laptop:max-w-xl tablet:mb-10 laptop:pb-8 shadow-2xl border-2">
      <select
        name="city"
