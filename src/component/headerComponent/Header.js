                        ...
                        >
                          ...
                          <div className="pl-4 text-left">
                            ...
                            <p className="leading-10 tracking-wide hover:text-primary">
                              ...
                              <br></br> điện tử, giao nhanh toàn quốc,<br></br>{" "}
                              miễn phí thu hộ COD, miễn phí<br></br> giao lại,
                              miễn phí trả hàng.
                            </p>
                          </div>
                        </Link>
                        ...
                        >
                          ...
                          <div className="pl-4 text-left">
                            ...
                            <p className="tracking-tight leading-10  hover:text-primary">
                              Dịch vụ kho bãi và xử lý hàng hóa,<br></br> diện
                              tích kho bãi hơn 100.000m2<br></br> giúp bạn tối
                              ưu nhu cầu xuất-<br></br>nhập-tồn kho.
                            </p>
                          </div>
                        </Link>
                      </div>
                    ...
                    <div className="h-[90px] col-sm-12 border-[1px] p-4 pt-8  border-primary">
                      ...
                      >
                        ...
                        <div className="pl-4 text-left">
                          ...
                          <p className="tracking-tight leading-10  hover:text-primary">
                            Dịch vụ giao hàng tức thời 30 phút - 4 giờ trong nội
                            thành Hồ Chí Minh và Hà Nội.
                          </p>
                        </div>
                      </a>
                    </div>
