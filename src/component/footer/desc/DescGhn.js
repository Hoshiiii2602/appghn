  ...
  return (
    <div className="grid laptop:grid-cols-8 tablet:grid-cols-2 laptop:gap-2 tablet:gap-6">
      <div className="laptop:col-span-3 tablet:col-span-1">
        ...
        <span>
          Công ty giao nhận đầu tiên tại Việt Nam được thành lập<br></br>
          với sứ mệnh phục vụ nhu cầu vận chuyển chuyên
          <br></br> nghiệp của các đối tác Thương mại điện tử trên toàn<br></br>{" "}
          quốc.
        </span>
        <br></br>
        <span>
          Giấy CNĐKDN: 0311 907 295 do Sở Kế Hoạch và Đầu Tư<br></br>
          TP HCM cấp lần đầu ngày 02/08/2012, cấp thay đổi lần<br></br> thứ 16
          ngày 10/5/2019.
        </span>
      </div>
      <div className="col-span-1 tablet:ml-10 mobile:ml-0">
        <div className="mb-6">
          <span className="text-2xl font-[600]">VỀ GHN</span>
          <br></br>
        </div>
        <div className="mb-4">
          <a
      ...
      <div className="col-span-2 laptop:block mobile:hidden tablet:hidden">
        <div className="mb-6">
          <span className="text-2xl font-[600]">THÔNG TIN DỊCH VỤ</span>
          <br></br>
        </div>
        <div className="mb-4">
          <a
        ...
        <div className="mb-4">
          <a className="hover:text-primary hover:cursor-pointer hover:no-underline">
            Quy trình gửi hàng
          </a>
        </div>
        <div className="mb-4">
      ...
      <div className="col-span-2 laptop:block tablet:hidden mobile:hidden">
        <div className="mb-6">
          <span className="text-2xl font-[600]">CHÍNH SÁCH</span>
          <br></br>
        </div>
        <div className="mb-4">
          <a className="hover:text-primary hover:cursor-pointer hover:no-underline">
