  ...
  return (
    <div className="grid grid-cols-10 mt-20 items-start ">
        ...
        <div className="grid grid-rows-2">
          <div className="flex items-center">
            <img
              ...
              alt="GHN"
            ></img>
            <h4 className="font-bold text-2xl leading-9">
      ...
      <div className="col-span-2 mt-2">
        <h4 className="font-bold text-2xl">KẾT NỐI VỚI GHN</h4>
      ...
      <div className="col-span-2">
        ...
        <button className="border-[1px] hover:border-[1px] hover:border-primary border-primary mt-4 p-3 z-[1] rounded-xl location">
          <a
            className="hover:no-underline hover:text-black text-white"
      ...
      <div className="col-span-2">
        ...
        <div className="flex items-center w-[120%]">
          <input
            ...
            className="border-[1px] rounded-xl focus:outline-none border-[#a6a6a6]  mt-4 p-3 w-[120%]"
          ></input>
          <button className="p-3 ml-4 mt-4 registor rounded-xl z-[1] text-white">
            GỬI
          </button>
        </div>
      </div>
