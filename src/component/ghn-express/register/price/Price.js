        ...
        <div className='mt-52 mb-20'>
            ...
            <div className='laptop:grid grid-cols-3 '>
                <div className='col-span-1'>
                    <ul>
                        <li className="">
                            <div onClick={(e) => Open('parent1', 'i1', 'i2', 'province')} id='parent1' className='h-[66px] pl-8 rounded-l-2xl relative items-center active parent hover:drop-shadow-[20px] hover:transition-all ease-in-out delay-75 flex justify-start py-8 border-t-[1px] hover:bg-[#00467f] hover:text-white'>
                        ...
                        <li className=''>
                            <div onClick={(e) => Open('parent2', 'i3', 'i4', 'leangue')} id='parent2' className='items-center pl-8 rounded-l-2xl parent hover:drop-shadow-[20px] hover:transition-all ease-in-out delay-75 flex justify-start py-8 border-t-[1px] hover:bg-[#00467f] hover:text-white'>
                                <span className='w-[25px] h-[25px]'>
                        ...
                        <li className=''>
                            <div onClick={(e) => Open('parent3', 'i5', 'i6', 'special')} id='parent3' className='items-center pl-8 rounded-l-2xl parent hover:drop-shadow-[20px] hover:transition-all ease-in-out delay-75 flex justify-start py-8 border-t-[1px] hover:bg-[#00467f] hover:text-white'>
                                <span className='w-[25px] h-[25px]'>
                        ...
                        <li className=''>
                            <a href='/price/view-detail' className='hover:no-underline '>
                                <div onClick={(e) => Open('parent4', 'i7', 'i8', e)} id='parent4' className='items-center pl-8 rounded-l-2xl parent hover:drop-shadow-[20px] hover:transition-all ease-in-out delay-75 flex justify-start py-8 border-t-[1px] hover:bg-[#00467f] hover:text-white'>
                                    <span className='w-[25px] h-[25px]'>
