  ...
  return (
    <div className="mt-[50px] text-center laptop:container">
      <div className="mt-[120px]">
        ...
        <p className="text-[#84868d] mt-28">
          GHN giúp bạn giao hàng đến người nhận nhanh hơn 6 tiếng so với các đơn
          vị vận chuyển khác
        </p>
      </div>
      <div className="laptop:h-[548px] mt-20">
        <video
          className="laptop:block mobile:hidden laptop:h-[540px] laptop:w-full"
          autoPlay
          loop
          muted
          preload="auto"
      ...
      <div className="flex tablet:justify-around  mt-6 ml-4">
        <div>
          <p className="text-[#84868d]">
            Top công ty giao<br></br>nhận hàng đầu VN
          </p>
        </div>
        <div>
          <p className="text-[#84868d]">
            Mạng lưới phủ sóng<br></br>100% 63 tỉnh thành
          </p>
        </div>
        <div>
          <p className="text-[#84868d]">
            Giao hàng nhanh<br></br>Tỷ lệ hoàn hàng thấp
          </p>
        </div>
        <div>
          <p className="text-[#84868d]">
            Hệ thống quản lý<br></br>trực tuyến 24/7
          </p>
        </div>
      </div>
    </div>
